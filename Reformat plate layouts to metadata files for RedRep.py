...
os.chdir("Q:/My Drive/GS_ReFUS_files/Predictions_2018_C4")

layout = pd.read_csv("ReFUS C4 NGS Library plate layout.csv")
layout.head()
...
#make library_id
layout2['library_id'] = 'ReFUSC4_' + layout2['Library']

#get the indexer info 
#in our case, we have four total plates, so we need to repeat this indexer info 8 times:
...
common_vals = {'person':'Josie_Bloom', 'date_submit':'3/20/2018', 'date_return':'4/4/2018', 
...
layout2['entry'] = '17FL0' + layout2.Row_Plant
